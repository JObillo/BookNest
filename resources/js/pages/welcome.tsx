      ...
      <div className="flex flex-col min-h-screen bg-gray-100 text-gray-900 p-4 sm:p-6">
        ...
        <div className="mt-4 sm:mt-6 flex justify-start w-full max-w-3xl">
          <input
            ...
            // className="w-full max-w-xs px-50 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring focus:border-purple-500"
            ...
            Object.keys(groupedBooks).map((sectionName) => {
              ...
              return (
                <div key={sectionName}>
                  ...
                  {/* Books Grid */}
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 c:">
