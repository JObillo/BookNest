...
const breadcrumbs: BreadcrumbItem[] = [{ title: 'Report - Least Borrowed Books', href: '/reports/least-borrowed' }];
...
export default function LeastBorrowed() {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            {/* Table */}
            <div className="mt-4 flex flex-col gap-6 rounded bg-white p-6 text-black shadow-lg">
                <div className="overflow-x-auto">
                    <table className="w-full border-collapse rounded-lg bg-white text-black shadow-sm">
                        <thead>
                            <tr className="border-b bg-red-900 text-white">
                            ...
                            {displayedBooks.length ? (
                                displayedBooks.map((item) => (
                                    <tr key={item.book?.id} className="border-b hover:bg-gray-100">
                                        ...
                                        <td className="p-3 font-semibold text-red-700">{item.borrow_count}</td>
                                    </tr>
                                ))
                            ) : (
                                <tr>
                ...
                <div className="mt-4 flex cursor-pointer items-center justify-between px-4 py-3 text-sm text-gray-700">
                    ...
                    <div className="flex items-center gap-1">
                        ...
                        <span className="rounded bg-red-700 px-3 py-1 text-white">{currentPage}</span>
